  ...
  return (
    <View style={{flexDirection: 'row'}}>
      {data.map((_, i) => {
        ...
        return (
          <View key={i.toString()} style={{marginRight: 20}}>
            {/* active */}
            <Animated.View style={{opacity: active, backgroundColor: '#000', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 999, zIndex: 0}}>
            ...
            <Animated.View style={{position: 'absolute', opacity: inactive, zIndex: 1}}>
              <TouchableWithoutFeedback onPress={() => {
                ...
                <View style={{backgroundColor: '#eee', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 999}}>
